...
class ConnectFour:
    """This class will simulate the board activity logic and status"""
    ...
    def checkResults(self):
        """This method will check get the status of the 
        game after the current move. Furhermore it will return 
        win, draw, or false - which means that the game is still on"""
        numOfDiscs = 0
